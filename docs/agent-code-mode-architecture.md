...
| CM-43 CBL section A/B experiment | In progress | Async v2 runner corrected (`ca8e80d`); corrected live evidence returns `STOP_SDK_CONTEXT_GAP` and is pending finalization |
