...
| CM-48 Bounded visual correction | Complete (`a0c0a25`) | Root-only section visual review, one scoped correction, private preservation, and bounded render/review gates pass |
