...
- `user/agent_las_step_by_step.ipynb`
- `user/agent_cbl_log_example_from_prompt.ipynb`
...
- the agent-assisted notebook now reports a concise deterministic summary of
  completed work, skipped work, warnings, and provable request inconsistencies
  before each preview image
