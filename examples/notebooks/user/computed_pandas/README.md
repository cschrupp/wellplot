# Computed-Channel pandas Notebooks

These notebooks start from the same two production examples as the YAML-first user recipes,
but compute new interpretation channels with pandas before building the layout.
...
- `cbl_log_example_pandas_computed.ipynb`
- `forge16b_porosity_example_pandas_computed.ipynb`
