    ...
    "$defs": {
        ...
        "matplotlibStyleCurveCallouts": {
            ...
            "properties": {
                ...
                "label_mode": {"type": "string", "enum": ["none", "free", "dedicated_lane"]},
                "label_lane_start": {"type": "number", "minimum": 0, "maximum": 1},
                "label_lane_end": {"type": "number", "minimum": 0, "maximum": 1},
            },
        },
        "matplotlibStyleGrid": {
            "type": "object",
        ...
        "annotationObject": {
            "oneOf": [
                ...
                {"$ref": "#/$defs/annotationMarker"},
                {"$ref": "#/$defs/annotationArrow"},
                {"$ref": "#/$defs/annotationGlyph"},
            ]
        },
        "annotationInterval": {
            "type": "object",
        ...
        "annotationMarker": {
            ...
            "properties": {
                ...
                "color": {"type": "string", "minLength": 1},
                "fill_color": {"type": "string", "minLength": 1},
                "edge_color": {"type": "string", "minLength": 1},
                "line_width": {"type": "number", "exclusiveMinimum": 0},
                "label": {"type": "string"},
                "text_side": {"type": "string", "enum": ["auto", "left", "right"]},
                "text_x": {"type": "number", "minimum": 0, "maximum": 1},
        ...
        "annotationArrow": {
            "type": "object",
            "required": ["kind", "start_depth", "end_depth", "start_x", "end_x"],
            "additionalProperties": False,
            "properties": {
                "kind": {"type": "string", "const": "arrow"},
                "start_depth": {"type": "number"},
                "end_depth": {"type": "number"},
                ...
                "arrow_style": {"type": "string", "minLength": 1},
                "label": {"type": "string"},
                "label_x": {"type": "number", "minimum": 0, "maximum": 1},
                "label_depth": {"type": "number"},
                "font_size": {"type": "number", "exclusiveMinimum": 0},
                "font_weight": {"type": "string", "minLength": 1},
                "font_style": {"type": "string", "minLength": 1},
