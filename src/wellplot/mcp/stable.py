        ...
        if operation == "add":
            ...
            return _mutation(
                ...
                lambda: service.bind_raster(
                    ...
                    waveform_normalization=args.get("waveform_normalization"),
                    clip_percentiles=args.get("clip_percentiles"),
                    ...
                    colorbar=args.get("colorbar"),
                    sample_axis=args.get("sample_axis"),
